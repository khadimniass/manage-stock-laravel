    ...
    <x-div-card>
        ...
        <form action="{{ route('Entree.store') }}" method="post">
            ...
            <div>
                ...
                <x-input id="quantite" class="block mt-1 w-full" type="number" name="quantite" :value="old('quantite')" required autofocus />
            </div>

            <div>
                <x-label for="prix" :value="__('Prix')" />

                <x-input id="prix" class="block mt-1 w-full" type="number" name="prix" :value="old('prix')" required autofocus />
            </div>
